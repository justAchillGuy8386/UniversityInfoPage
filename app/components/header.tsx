      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/news" className="text-gray-700 hover:text-blue-600 font-medium transition">
              Tin tức
            </Link>
            <Link href="/departments" className="text-gray-700 hover:text-blue-600 font-medium transition">
              Khoa
            </Link>
            <Link href="/admissions" className="text-gray-700 hover:text-blue-600 font-medium transition">
              Tuyển sinh
            </Link>
