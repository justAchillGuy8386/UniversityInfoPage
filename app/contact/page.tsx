  ...
  return (
    <div className="min-h-screen">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+842812345678" className="hover:text-blue-600 transition">
                        (028) 1234-5678
                      </a><br />
                      <a href="tel:+84123456789" className="hover:text-blue-600 transition">
                        0123-456-789
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@university.edu.vn" className="hover:text-blue-600 transition">
                        info@university.edu.vn
                      </a><br />
                      <a href="mailto:admissions@university.edu.vn" className="hover:text-blue-600 transition">
                        admissions@university.edu.vn
                      </a>
                    </p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">Vị trí trường</h2>
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="h-96 bg-gradient-to-r from-blue-400 to-purple-500 flex items-center justify-center">
              <div className="text-white text-center">
                ...
                <p className="text-xl">Bản đồ tương tác</p>
